from bottle import request, redirect, route, run, debug,error, template, static_file, BaseRequest
	    ...
	    <div class="center">
                <span id = "signinButton">
                    <span
                        ...
                        data-clientid="921689403482.apps.googleusercontent.com"
                        data-cookiepolicy="single_host_origin"
                        data-requestvisibleactions="http://schemas.google.com/AddActivity"
                        data-scope="https://www.googleapis.com/auth/plus.login">
                    </span>
                </span>
                <span id = "revokeButton"></span>
